...
const Banner = (props: IBanner) => {
  return (
    <>
      <section className="relative w-full h-[300px] lg:h-[500px] flex items-center justify-center p-4">
        {/* Background color */}
        ...
        {/* Balls on corners */}
        <div className="top-[-150px] left-[-150px] h-96 w-96 rounded-full bg-gray-200 opacity-20 absolute blur-2xl overflow-hidden"></div>
        <div className="bottom-[-150px] right-[-150px] h-96 w-96 rounded-full bg-gray-400 opacity-20 absolute blur-2xl overflow-hidden"></div>
      </section>
    </>
  );
};
