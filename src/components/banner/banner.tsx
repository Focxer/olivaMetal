...
const Banner = (props: IBanner) => {
  return (
    <section className="relative max-w-screen h-[300px] lg:h-[500px] flex items-center justify-center overflow-hidden">
      {/* Background color */}
      <div className="h-full w-full absolute bg-gradient-to-r from-zinc-100 to-blue-200" />
      <div className="flex flex-col md:flex-row items-center justify-center w-screen gap-4">
        <img
