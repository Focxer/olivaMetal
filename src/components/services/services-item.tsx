...
const ServicesItem = (props: IServicesItem) => {
  return (
    <div
      id="main"
      className="relative flex flex-col items-center justify-center drop-shadow-lg transition-all duration-200 group lg:h-96 lg:w-96 w-32 h-32 flex-grow overflow-hidden"
    >
      <img
        src={props.img}
        alt={props.alt}
