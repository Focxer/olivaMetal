...
const NavBar = () => {
  return (
    <>
      ...
      <ul
        id="navBurger"
        className="ease-in-out hidden lg:hidden transform -translate-y-full w-full bg-zinc-900 bg-opacity-50 backdrop-blur-md fixed top-0 right-0 p-4 pt-12 sm:pt-10 shadow-lg transition-transform duration-200"
      >
